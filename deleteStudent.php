...
/*
    ...
    */
    ...
    $sql = "SELECT _imie, _nazwisko FROM uczniowie WHERE  _id = $id AND _szkola_id = $sId";
    ...
    {
        header("Location: students.php?n=0");
    }

    if(isset($_POST['delete']))
    {
        $sql = "DELETE FROM uczniowie WHERE _id = $id AND _szkola_id = $sId";

        if ($conn->query($sql) === TRUE) 
        {
            
            header("Location: students.php?n=1");
        } 
        else 
        {
...
<BODY id="main" style="border-radius: 10px;">
	...
	<div class="weatherinfo" id="sli">
        ...
        <div class="appinfo">
			<p class="name">Czy napewno chcesz usunąć ucznia:</p>
        ...
        <br />
		<a href = "students.php"><button class="mainbut" style = "background-color: silver" >Anuluj</button></a>
